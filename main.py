...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'bijayakumarbehera123.com' ")
...
def TakeImages():
    ...
    serial = 0
    exists = os.path.isfile("Year\StudentDetails\StudentDetails.csv")
    if exists:
...
window.title("Attendance Management System (BIJAYA BEHERA)")
...
message3 = tk.Label(window, text="ATTENDANCE SYSTEM USING FACE DETECTION" ,fg="white",bg="purple" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="orange",bg="purple" ,width=100 ,height=1,font=('times', 18, ' bold '))
datef.pack(fill='both',expand=2)

clock = tk.Label(frame3,fg="orange",bg="purple" ,width=100 ,height=1,font=('times', 18, ' bold '))
...
message1 = tk.Label(frame2, text="1)Take Images  >>>  2)Save Profile" ,bg="darkred" ,fg="white"  ,width=39 ,height=1, activebackground = "gold" ,font=('times', 15, ' bold '))
...
scroll.grid(row=3,column=4,padx=(0,100),pady=(150,0),sticky='ns')
